...
function s:AddTitle()
	...
	call setline('.',noTypeChar.'*')
	normal o
	call setline('.',noTypeChar.preChar.' (C) 2010-2012 ChenXiaohui Holding Limited.')
	normal o
	call setline('.',noTypeChar.'*')
	normal o
	call setline('.',noTypeChar.preChar.' This program is free software; you can redistribute it and/or')
	normal o
	call setline('.',noTypeChar.preChar.' modify it under the terms of the GNU General Public License')
	normal o
	call setline('.',noTypeChar.preChar.' version 2 as published by the Free Software Foundation.')
	normal o
	call setline('.',noTypeChar.'*')
	call setline('.',noTypeChar.'*')
	normal o
	call setline('.',noTypeChar.preChar.' '.expand("%:t").' is for')
	normal o
	let gotoLn = line('.')
	call setline('.',noTypeChar.'*   ')
	normal o
	call setline('.',noTypeChar.preChar.' Authors:')
	normal o
	call setline('.',noTypeChar.preChar.'   chenxiaohui <sdqxcxh@gmail.com>')
	normal o
	call setline('.',noTypeChar.'')
	let lastLine = line('.')
...
function s:AddTitleAli()
	...
	call setline('.',noTypeChar.'*')
	normal o
	call setline('.',noTypeChar.preChar.' (C) 2010-2012 Alibaba Group Holding Limited.')
	normal o
	call setline('.',noTypeChar.'*')
	normal o
	call setline('.',noTypeChar.preChar.' This program is free software; you can redistribute it and/or')
	...
	call setline('.',noTypeChar.preChar.' Authors:')
	normal o
	call setline('.',noTypeChar.preChar.'   yuzhang <xiaohui.cpc@alibaba-inc.com>')
	normal o
	call setline('.',noTypeChar.'')
	let lastLine = line('.')
	...
	echohl WarningMsg | echo "Succ to add the copyright." | echohl None
endf
command! -nargs=0 AuthorInfoDetectAli :call s:AddTitleAli()
